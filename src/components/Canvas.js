...
import { updateElement, selectElement } from '../features/elements/elementsSlice';
...
const Canvas = () => {
  ...
  return (
    <div className="canvas bg-gray-100 h-screen w-screen relative ml-64 mr-64 pt-16">
          ...
          >
            ...
            {element.type === 'field' && (
              <input
                ...
                onChange={(e) => dispatch(updateElement({ id: element.id, properties: { value: e.target.value } }))}
              />
            )}
            {element.type === 'image' && (
